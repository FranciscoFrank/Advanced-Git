...
>[!NOTE]
>
>Функціонал, який пропонує Git Submodule, корисний, коли йде розробка сайту, і команда розробки не хоче писати код, а використати вже готову бібліотеку для цього. Звичайно, можна використати готовий код цієї бібліотеки прямо в своєму проєкті, але вона може не працювати на пристроях всіх клієнтів, а в разі оновлення цієї бібліотеки вам буде досить важко злиття цих змін із вашим проєктом. Саме для таких ситуацій і придумали Git Submodule.
>\
